...
% 06.24.2021)CDCssbGFPmcherry.csv and returns length vs at time ts for all
% cells being analyzed. Also returns if the cell is accelerator or
% alternator

function [vs, ts, ty] = analysis_06_24()
...
txt=[];
raw=[];
[num,txt,raw] = xlsread('./data/processed data/(Christin 06.24.2021)CDCssbGFPmcherry.xlsx');
txt= txt(2:end,1);
