...
% gets data from File- .data/processed data/(Christin
% 09.03.2021)CDCssbGFPmcherry_2.csv and returns length vs at time ts for all
% cells being analyzed. Also returns if the cell is accelerator or
% alternator

function [vs, ts, ty] = analysis_09_03_2()
...
txt=[];
raw=[];
[num,txt,raw] = xlsread('./data/processed data/(Christin 09.03.2021)CDCssbGFPmcherry_2.csv');
txt= txt(2:end,1);
